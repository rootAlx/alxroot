...
<div class="row">
  ...
  $primeiroParallaxpost =get_post_meta( $post->ID ,'postParallaxImg',true);
  $primeiroParallaxColorText =get_post_meta( $post->ID ,'TextoColorTituloParallax',true);
  $sloganParallax2 = get_post_meta( $post->ID ,'sloganParallaxpost',true);
  $sloganParallaxColor = get_post_meta( $post->ID ,'sloganColorSloganPost',true);
  

  ?>
  <section class="col s12 m12 xl12 parallax-container " style="position: relative; margin-top: -66px;">
   
    <div class="parallax"><?php  echo wp_get_attachment_image($primeiroParallaxpost, 'full', 'responsive-img',array(  'class' => 'responsive-img  pageTituloCroll2', )  );?></div>
...
<div class="row">
 ...
 <section class="col s12 m12 xl12  parallax-container">
  <?php 
  $segundoParallaxpage =get_post_meta( $post->ID ,'parallaxpost2imagem',true);
  ?>
  <div class="parallax">
    <?php  echo wp_get_attachment_image( $segundoParallaxpage, 'full', 'responsive-img',array(  'class' => 'responsive-img ', )  );?>
  </div>
  <div class="col s12 m12 xl12" style="margin-top: 13em;">    	 
