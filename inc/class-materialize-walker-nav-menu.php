...
class Materialize_Walker_Nav_Menu extends Walker_Nav_Menu {
   ...
   //s$cor = get_theme_mod( 'set_menu1Cor' ,'#7cb342 light-green darken-1');
   $menuCorFundo="corDrop";
		$this->cor = get_theme_mod( 'set_parallaxmenuColor',$menuCorFundo);
		$output .= "{$n}{$indent}<ul id=\"$this->submenu_unique_id\" class=\" ' $this->cor 'sub-menu dropdown-content\">{$n}";
	}
